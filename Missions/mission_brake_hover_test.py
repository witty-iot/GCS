...
MISSION = {
    "steps": [
        ...
        {"action": "brake_hover", "seconds": BRAKE_SECONDS},
        {"action": "land"},
    ]
}
...
def upload_start_monitor(start_immediately):
    ...
    print(f"\n[1/3] Uploading brake-hover test ({len(MISSION['steps'])} steps)...")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="ESP32 brake-hover test mission")
